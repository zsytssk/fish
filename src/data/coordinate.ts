...
export const Coordinates = {
    ...
    shadowPos: {
        default: { x: 0, y: 80 },
        '1': { x: 0, y: 60, scaleX: 0.35, scaleY: 0.35 },
        '2': { x: 0, y: 70, scaleX: 0.49, scaleY: 0.49 },
        '3': { x: 0, y: 70, scaleX: 0.5, scaleY: 0.5 },
        '4': { x: 0, y: 100, scaleX: 0.8, scaleY: 1.2 },
        '5': { x: 0, y: 80, scaleY: 0.8, scaleX: 0.84 },
        '6': { x: 0, y: 70, scaleX: 0.43, scaleY: 0.43 },
        '7': { x: 0, y: 80, scaleX: 0.5, scaleY: 0.5 },
        '8': { x: 0, y: 120, scaleX: 0.6, scaleY: 1 },
        '9': { x: 0, y: 120, scaleX: 0.7, scaleY: 1.1 },
